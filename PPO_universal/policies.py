...
class Actor_Gaussian(nn.Module):
    ...
    def forward(self, s):
        ...
        return mean, (self.mean_layer.weight, self.fc1.weight, self.fc2.weight)

    def get_dist(self, s):
        mean, weights = self.forward(s)
...
class Actor_Discrete(nn.Module):
    ...
    def forward(self, s):
        ...
        return a_probs, (self.mean_layer.weight, self.fc1.weight, self.fc2.weight)

    def get_dist(self, s):
        a_probs, weights = self.forward(s)
